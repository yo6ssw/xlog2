...
// org.freedesktop.RealtimeKit1 system D-Bus service — the same privileged broker
// PipeWire / PulseAudio use. This works on an ordinary desktop with no rtprio
// limit in limits.conf, because rtkit (running with privilege) grants RT
