...
int IniFile::getInt(const std::string& group, const std::string& key, int def) const {
    if (!hasKey(group, key))
        return def;
    try {
...
bool IniFile::getBool(const std::string& group, const std::string& key, bool def) const {
    if (!hasKey(group, key))
        return def;
...
void IniFile::setInt(const std::string& group, const std::string& key, int value) {
    data_[group][key] = std::to_string(value);
}

void IniFile::setBool(const std::string& group, const std::string& key, bool value) {
