...
void setField(Qso& q, const std::string& name, const std::string& value) {
    if (name == "qso_date")        q.date     = dateFromAdif(value);
    else if (name == "time_on")    q.time_on  = timeFromAdif(value);
    else if (name == "time_off")   q.time_off = timeFromAdif(value);
    else if (name == "call")       q.call     = toUpper(value);
    else if (name == "band")       q.band     = toLower(value);
    else if (name == "mode")       q.mode     = toUpper(value);
    else if (name == "freq")       q.freq     = value;
    else if (name == "rst_sent")   q.rst_sent = value;
    else if (name == "rst_rcvd")   q.rst_rcvd = value;
    else if (name == "name")       q.name     = value;
    else if (name == "qth")        q.qth      = value;
    else if (name == "gridsquare") q.locator  = toUpper(value);
...
void writeField(std::ostringstream& os, const std::string& name, const std::string& value) {
    if (value.empty())
        return;
